...
export { DNS, LocationToGeoDomain, MapsDiscovery, MapServer, LocalizationData, WayPoint, MapServerServiceDescription, MapServerCapabilities, axios, Events, exportedForTesting };
